...
The HTTP API is the primary means for querying data in InfluxDB (see the [command line interface](../../tools/shell/) and [client libraries](../../clients/api/) for alternative ways to query the database).
...
The example below uses the HTTP API to query the same database that you encountered in [Writing Data](../writing_data/).
<br>
```sh
...
See [Authentication and Authorization](../../administration/authentication_and_authorization/) for how to enable and set up authentication.
...
### InfluxQL
---
Now that you know how to query data, check out the [Data Exploration page](../../query_language/data_exploration/) to get acquainted with InfluxQL.

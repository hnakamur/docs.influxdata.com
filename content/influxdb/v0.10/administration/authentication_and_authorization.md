...
> **Note:** If you enable authentication and have no users, InfluxDB will **not** enforce authentication until you create the first admin user, and InfluxDB will only accept the [query](#create-a-new-admin-user) that creates an admin user.
...
See the [database management](../../query_language/database_management/) and [continuous queries](../../query_language/continuous_queries/) page for a complete discussion of the commands listed above.
...
>
    ```
    > **Note:** The password [string](../../query_language/query_syntax/#string-literals-single-quoted) must be wrapped in single quotes.

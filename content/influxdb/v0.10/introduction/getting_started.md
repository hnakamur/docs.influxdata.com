...
With InfluxDB [installed](../installation), you're ready to start doing some awesome things.
...
See [Writing Data](../../guides/writing_data/) and [Querying Data](../../guides/querying_data/)
...
> **Note:** More information on the line protocol can be found on the [Write Syntax](../../write_protocols/write_syntax/) page.
...
InfluxQL has many [features and keywords](../../query_language/spec/) that are not covered here,
...
check out the guide on [Writing Data](../../guides/writing_data/).
To futher explore the query language,
check out the guide on [Querying Data](../../guides/querying_data/).
For more information on InfluxDB concepts, check out the [Key Concepts]
(../../concepts/key_concepts/) page.

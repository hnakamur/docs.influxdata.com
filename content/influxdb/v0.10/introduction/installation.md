...
- TCP port `8083` is used for InfluxDB's [Admin panel](../../tools/web_admin/)
...
All port mappings can be modified through the [configuration file](../../administration/config),
...
<a href="../getting_started/"><font size="6"><b>⇒ Now get started!</b></font></a>
...
For more detailed instructions on how to set up a cluster, please see the [Clustering](../../guides/clustering/) section.

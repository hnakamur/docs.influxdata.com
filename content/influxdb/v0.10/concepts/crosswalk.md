...
InfluxDB's [continuous queries](../../query_language/continuous_queries/)
and [replication policies](../../administration/administration/) are
...
For more detailed descriptions of the InfluxDB terms mentioned in this section see our [Glossary of Terms](../glossary/).
...
See our [data exploration](../../query_language/data_exploration/) page for an in-depth discussion of those topics.
InfluxQL functions include `COUNT`, `MIN`, `MAX`, `MEDIAN`, `DERIVATIVE` and more.
For a full list check out the [functions](../../query_language/functions/) page.

Now that you have the general idea, check out our [Getting Started Guide](../../introduction/getting_started/).

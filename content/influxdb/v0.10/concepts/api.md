...
This will check with the leader of the [cluster](../glossary/#cluster) to ensure that the leader is available and ready.
...
### /query
For more information on the `/query` endpoint see the [Querying Data](../../guides/querying_data/) section of our docs.

### /write
For more information on the `/write` endpoint see the [Writing Data](../../guides/writing_data/) section of our docs.

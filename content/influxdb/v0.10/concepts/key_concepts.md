...
Check out the [Glossary](../glossary/) if you prefer the cold, hard facts.
...
See [users](../../administration/authentication_and_authorization/) and [continuous queries](../../query_language/continuous_queries/) for more on those topics.
